...
func (c *identityServiceClient) BatchGetNicknames(ctx context.Context, in *BatchGetNicknamesRequest, opts ...grpc.CallOption) (*BatchGetNicknamesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchGetNicknamesResponse)
	err := c.cc.Invoke(ctx, IdentityService_BatchGetNicknames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IdentityService_BatchGetNicknames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchGetNicknamesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServiceServer).BatchGetNicknames(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IdentityService_BatchGetNicknames_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceServer).BatchGetNicknames(ctx, req.(*BatchGetNicknamesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
